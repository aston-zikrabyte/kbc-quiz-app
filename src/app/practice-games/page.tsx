              ...
              <div className="mb-20 flex flex-col gap-3">
                ...
                <div className="grid grid-cols-2 gap-6 md:grid-cols-3">
                  ...
                  <div
                    ...
                    onClick={() => setActiveAmount("multiplayer1v1-250")}
                  >
                    <p className="text-2xl">🪙</p>
              ...
              <div className="mb-20 flex flex-col gap-3">
                ...
                <div className="grid grid-cols-2 gap-6 md:grid-cols-3">
                  <div
                    ...
                    onClick={() => setActiveAmount("multiplayer1v9-20")}
                  >
                    <p className="text-2xl">🪙</p>
                  ...
                  <div
                    ...
                    onClick={() => setActiveAmount("multiplayer1v9-50")}
                  >
                    <p className="text-2xl">🪙</p>
                    <p className="text-sm">₹50</p>
                    <div
                  ...
                  <div
                    ...
                    onClick={() => setActiveAmount("multiplayer1v9-100")}
                  >
                    <p className="text-2xl">🪙</p>
                    <p className="text-sm">₹100</p>
                    <div
                  ...
                  <div
                    ...
                    onClick={() => setActiveAmount("multiplayer1v9-150")}
                  >
                    <p className="text-2xl">🪙</p>
                    <p className="text-sm">₹150</p>
                    <div
