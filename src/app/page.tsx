  ...
  return (
    <>
      <div className="static z-10 flex h-full flex-col gap-10 overflow-visible min-[2000px]:px-80 min-[3200px]:px-120">
        ...
        <section
          id="home"
          className="grid min-h-screen grid-cols-1 gap-8 px-4 pb-10 md:grid-cols-12 md:px-10 md:py-20 lg:gap-20 lg:px-20"
        >
          ...
          <div className="order-1 mb-8 flex items-center justify-center rounded-xl md:order-2 md:col-span-5 md:mb-0">
            <div className="relative aspect-[4/5] w-full">
              <Image
                src="/img/landing_images/landing-img1.png"
                alt="KBC Quiz"
                fill
        ...
        <section className="grid min-h-screen grid-cols-1 gap-8 px-4 py-10 md:grid-cols-12 md:px-10 md:py-20 lg:gap-20 lg:px-20">
          <div className="order-1 mb-8 flex items-center justify-center rounded-xl md:order-1 md:col-span-5 md:mb-0">
            <div className="relative aspect-[4/5] w-full">
              <Image
                src="/img/landing_images/landing-img2.png"
                alt="KBC Quiz"
                fill
                className="rounded-xl object-cover"
                sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 400px"
          ...
          <div className="order-2 flex flex-col justify-center p-2 md:col-span-7 md:p-4">
            <div>
        ...
        <section className="grid min-h-screen grid-cols-1 gap-8 px-4 py-10 md:grid-cols-12 md:px-10 md:py-20 lg:px-20">
          <div className="order-1 mb-8 flex items-center justify-center rounded-xl md:order-1 md:col-span-5 md:mb-0">
            <div className="relative aspect-[4/5] w-full">
              <Image
                src="/img/landing_images/landing-img4.png"
                alt="KBC Quiz"
                fill
                className="rounded-xl object-cover"
                sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 400px"
          ...
          <div className="order-2 flex flex-col justify-center p-2 text-gray-400 md:col-span-7 md:p-4">
            <div>
              <div className="inline-block rounded-md bg-gradient-to-r from-purple-700 via-blue-600 to-cyan-400 p-[1px]">
                <Image
                  src="/icons/award.png"
            ...
            <p className="mt-4">
              Top 10 players each week win big prizes! Check your position
              anytime with our <br />
