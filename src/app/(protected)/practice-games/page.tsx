...
const PracticeGames = () => {
  ...
  const [activeMultiplayer, setActiveMultiplayer] = useState<
    "withOne" | "withFive" | "withNine" | null
  >(null);
  ...
  return (
    <div className="flex h-[90vh] flex-col gap-5 px-5 py-5 font-bold text-white sm:px-20 md:px-30 lg:px-50 xl:px-70">
      <p className="text-4xl">Practice Games</p>
            ...
            <>
              <div className="flex flex-col gap-6">
                ...
                <div className="grid grid-cols-1 gap-3 lg:grid-cols-2">
                  ...
                  <div
                    className={`cursor-pointer rounded-lg border-t-2 border-t-[#202c38] ${activeMultiplayer === "withNine" ? "bg-[#AB39E8]" : "bg-[#0E161F]"} p-4 pb-7`}
                    onClick={() => {
                      setActiveMultiplayer("withNine");
                      setActiveAmount(null);
                      setActiveTopic(null);
                    }}
                  >
                    <p className="text-lg">1 v/s 9</p>
                    <p
                      className={`text-sm font-thin ${activeMultiplayer === "withNine" ? "" : "text-gray-400"}`}
                    >
                      Compete in a group
                    </p>
                  </div>
                ...
                {activeMultiplayer === "withOne" ? (
                  <div className="flex flex-col gap-3 md:mb-20">
                    ...
                    <div className="grid grid-cols-2 gap-6">
                      <div
                        ...
                        onClick={() => {
                          setActiveAmount("multiplayer1v1-100");
                        }}
                      >
                        <p className="text-2xl">🪙</p>
                        <p className="text-sm">₹100</p>
                      ...
                      <div
                        className={`flex h-40 w-full cursor-pointer flex-col items-center justify-center rounded-md ${activeAmount === "multiplayer1v1-250" ? "bg-[#AB39E8]" : "border-t-2 border-t-[#202c38] bg-[#0E161F]"} p-2`}
                        onClick={() => selectAmount("multiplayer1v1-250")}
                      >
                        <p className="text-2xl">🪙</p>
                        <p className="text-sm">₹250</p>
                        <div
                          className={`flex w-full items-center justify-center rounded-full ${activeAmount === "multiplayer1v1-250" ? "bg-[#bc6ce7]" : "bg-[#4BE0F1]/14"} p-1`}
                        >
                          <p className="text-xs">
                            Winning Prize:{" "}
                            <span
                              className={`${activeAmount === "multiplayer1v1-250" ? "text-white" : "text-[#4BE0F1]"}`}
                            >
                              ₹500
                            </span>
                          </p>
                  ...
                  <div className="flex flex-col gap-3 md:mb-20">
                    ...
                    <div className="grid grid-cols-2 gap-6">
                      <div
                        className={`flex h-40 w-full cursor-pointer flex-col items-center justify-center rounded-md ${activeAmount === "multiplayer1v5-25" ? "bg-[#AB39E8]" : "border-t-2 border-t-[#202c38] bg-[#0E161F]"} p-2`}
                        onClick={() => selectAmount("multiplayer1v5-25")}
                      >
                        <p className="text-2xl">🪙</p>
                        <p className="text-sm">₹25</p>
                        <div
                          className={`flex w-full items-center justify-center rounded-full ${activeAmount === "multiplayer1v5-25" ? "bg-[#bc6ce7]" : "bg-[#4BE0F1]/14"} p-1`}
                        >
                          <p className="text-xs">
                            Winning Prize:{" "}
                            <span
                              className={`${activeAmount === "multiplayer1v5-25" ? "text-white" : "text-[#4BE0F1]"}`}
                            >
                              ₹150
                            </span>
                          </p>
                ...
                ) : activeMultiplayer === "withNine" ? (
                  <div className="flex flex-col gap-3 md:mb-20">
                    <p>SELECT AMOUNT</p>
                    <div className="grid grid-cols-2 gap-6">
                      <div
                        className={`flex h-40 w-full cursor-pointer flex-col items-center justify-center rounded-md ${activeAmount === "multiplayer1v9-20" ? "bg-[#AB39E8]" : "border-t-2 border-t-[#202c38] bg-[#0E161F]"} p-2`}
                        onClick={() => selectAmount("multiplayer1v9-20")}
                      >
                        <p className="text-2xl">🪙</p>
                        <p className="text-sm">₹20</p>
                        <div
                          className={`flex w-full items-center justify-center rounded-full ${activeAmount === "multiplayer1v9-20" ? "bg-[#bc6ce7]" : "bg-[#4BE0F1]/14"} p-1`}
                        >
                          <p className="text-xs">
                            Winning Prize:{" "}
                            <span
                              className={`${activeAmount === "multiplayer1v9-20" ? "text-white" : "text-[#4BE0F1]"}`}
                            >
                              ₹200
                            </span>
                          </p>
                      ...
                      <div
                        className={`flex h-40 w-full cursor-pointer flex-col items-center justify-center rounded-md ${activeAmount === "multiplayer1v9-50" ? "bg-[#AB39E8]" : "border-t-2 border-t-[#202c38] bg-[#0E161F]"} p-2`}
                        onClick={() => selectAmount("multiplayer1v9-50")}
                      >
                        <p className="text-2xl">🪙</p>
                        <p className="text-sm">₹50</p>
                        <div
                          className={`flex w-full items-center justify-center rounded-full ${activeAmount === "multiplayer1v9-50" ? "bg-[#bc6ce7]" : "bg-[#4BE0F1]/14"} p-1`}
                        >
                          <p className="text-xs">
                            Winning Prize:{" "}
                            <span
                              className={`${activeAmount === "multiplayer1v9-50" ? "text-white" : "text-[#4BE0F1]"}`}
                            >
                              ₹500
                            </span>
                          </p>
                      ...
                      <div
                        className={`flex h-40 w-full cursor-pointer flex-col items-center justify-center rounded-md ${activeAmount === "multiplayer1v9-100" ? "bg-[#AB39E8]" : "border-t-2 border-t-[#202c38] bg-[#0E161F]"} p-2`}
                        onClick={() => selectAmount("multiplayer1v9-100")}
                      >
                        <p className="text-2xl">🪙</p>
                        <p className="text-sm">₹100</p>
                        <div
                        ...
                        >
                          <p className="text-xs">
                            Winning Prize:{" "}
                            <span
                              className={`${activeAmount === "multiplayer1v9-100" ? "text-white" : "text-[#4BE0F1]"}`}
                            >
                              ₹1000
                            </span>
                          </p>
                      ...
                      <div
                        className={`flex h-40 w-full cursor-pointer flex-col items-center justify-center rounded-md ${activeAmount === "multiplayer1v9-150" ? "bg-[#AB39E8]" : "border-t-2 border-t-[#202c38] bg-[#0E161F]"} p-2`}
                        onClick={() => selectAmount("multiplayer1v9-150")}
                      >
                        <p className="text-2xl">🪙</p>
                        <p className="text-sm">₹150</p>
                        <div
                          className={`flex w-full items-center justify-center rounded-full ${activeAmount === "multiplayer1v9-150" ? "bg-[#bc6ce7]" : "bg-[#4BE0F1]/14"} p-1`}
                        >
                          <p className="text-xs">
                            Winning Prize:{" "}
                            <span
                              className={`${activeAmount === "multiplayer1v9-150" ? "text-white" : "text-[#4BE0F1]"}`}
                            >
                              ₹1500
                            </span>
                          </p>
